...
<td valign="top">:</td>
<td><input name="date" type="text" id="date" size="40" readonly value="<?php date_default_timezone_set('Asia/Jakarta'); echo date("d-M-y, h:i:s")?>" style="background-color:#f0f0f0;color:#999;" class="form-control"/></td>
</tr>
<tr>
<?php
$x=rand(1,9);
