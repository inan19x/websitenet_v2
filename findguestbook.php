...
<tr>
<form id="form1" name="form1" method="post" action="searchguestbook.php">
<td>
<div class="hamidz">
<table width="400" border="0" cellpadding="3" cellspacing="1" bgcolor="#FFFFFF">
<tr>
<td width="117" style="color:#828282;">Email</td>
<td width="14" style="color:#828282;">:</td>
<td width="357"><input name="email" type="text" id="email" size="40" class="form-control"/></td>
</tr>
<tr>
<td>&nbsp;</td>
<td>&nbsp;</td>
<td>
<div class="jarak">
<input type="submit" name="Submit" value="Submit" class="btn btn-primary"/> <input type="reset" name="Submit2" value="Reset" class="btn btn-info"/>
</div>
</td>
</tr>
</table>
